...
const SupportForm = ({ toggleMainForm, formOpen }: { toggleMainForm: any; formOpen: any }) => {
	...
	return (
		<>
			...
			<Card className={` ${formOpen && "overflow-hidden"}  fixed z-10 max-h-screen top-10 bottom-10 left-10 right-10`}>
				<CardHeader className="relative py-12">
					<button
						className="absolute w-10 h-10 border rounded-md bg-zinc-50 hover:text-bold hover:border-black hover:border-2 top-5 right-5"
						onClick={toggleMainForm}>
						X
					</button>
