...
export default function Footer() {
	return (
		<footer className="bg-white ">
			<div className="px-6 pb-10 mx-auto overflow-hidden max-w-7xl py-14 sm:pt-14 lg:px-8">
				<nav className="-mb-6 columns-2 text-md sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
					{navigation.main.map((item) => (
						<div key={item.name} className="pb-6 ">
							<Link href={item.href} className="leading-6 text-gray-600 cursor-pointer hover:text-gray-900">
								{item.name}
							</Link>
						</div>
					))}
				...
				<div className="flex flex-col justify-between w-full mt-10 md:flex-row">
					...
					<div className="mt-8 md:order-1 md:mt-0">
						<p className="mt-3 text-sm text-center text-gray-500 align-middle md:leading-5">
