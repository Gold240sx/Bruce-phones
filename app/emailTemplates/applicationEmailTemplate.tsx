...
export const ApplicationEmailTemplate: any = ({ firstName, lastName, email, phone, address, userAccount, phoneCountryCode, qualification, DOB, lastFour, pickedProduct, status }: emailProps) => {
	const data = { firstName, lastName, email, phone, address, userAccount, phoneCountryCode, qualification, DOB, lastFour, pickedProduct, status }
